...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div className="flex justify-center items-center h-screen flex-col">
      <h1 className="text-6xl ml-[47rem] py-2 text-center font-bold leading-tight tracking-tight text-gray-900 md:text-6xl">
          CollabSphere
        </h1>
      ...
      <form
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 ml-[47rem] mb-[8rem]">
